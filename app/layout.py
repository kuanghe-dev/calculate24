...
calculate24_card = dbc.Card(
    [
        dbc.CardBody(
            [
                html.P(
                    ["Please input four integers between 1 and 9:"],
                        ...
                        dbc.Col(
                            html.Div(
                                [
                                    ...
                                    dbc.FormFeedback(
                                        "Need a number between 1 and 9.", type="invalid"
                                    ),
                                ],
                            ),
                            width=3,
                ...
                dbc.Row(
                    [
                        html.P(["Results:"], style={"fontWeight": "bold"}),
                        dbc.Col(
    ...
    [
        html.Div(
            [
                html.H1("24 Puzzle"),
                html.P(
                    "Find ways to manipulate four integers to get 24.", className="lead"
                ),
            ],
